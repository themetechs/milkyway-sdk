<?php
/**
 * The deactivate feedback model class for milkyway SDK
 *
 * @package     milkywaySDK
 * @subpackage  Feedback
...
if ( ! class_exists( 'milkyway_SDK_Feedback_Deactivate' ) ) :
	/**
	 * Deactivate feedback model for milkyway SDK.
	 */
	class milkyway_SDK_Feedback_Deactivate extends milkyway_SDK_Feedback {
		...
		function load_resources() {
			...
			echo '<div id="' . $id . '" style="display:none;" class="milkyway-deactivate-box">' . $this->get_html( $this->product->get_type(), $this->product->get_key() ) . '</div>';
		}
