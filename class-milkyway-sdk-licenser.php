 ...
 * @since       1.0.0
 */
if ( ! class_exists( 'milkyway_SDK_Licenser' ) ) :
	/**
	 * Class milkyway_SDK_Licenser
	 *
	 * Used to update the milkyway products
	 */
	class milkyway_SDK_Licenser {
		...
		/**
		 * @var milkyway_SDK_Product $product The milkyway Product.
		 */
		private $product;
		/**
		...
		/**
		 * milkyway_SDK_Licenser constructor.
		 *
		 * @param milkyway_SDK_Product $product The product object.
		 */
		...
		/**
		 * Register license hooks for the milkyway products
		 */
		...
		function update_nag() {
			...
			$update_message = apply_filters( 'milkyway_sdk_license_update_message', 'Updating this theme will lose any customizations you have made. Cancel to stop, OK to update.' );
