<?php
/**
 * The review feedback model class for milkyway SDK
 *
 * @package     milkywaySDK
 * @subpackage  Feedback
...
if ( ! class_exists( 'milkyway_SDK_Feedback_Review' ) ) :
	/**
	 * Deactivate feedback model for milkyway SDK.
	 */
	class milkyway_SDK_Feedback_Review extends milkyway_SDK_Feedback {
		...
		/**
		 * milkyway_SDK_Feedback_Deactivate constructor.
		 *
		...
		function admin_notices() {
			...
			echo '<div class="notice notice-success is-dismissible" id="' . $id . '" ><div class="milkyway-review-box">' . $this->get_html( $this->product->get_key() ) . '</div></div>';
		}
		...
		function get_html( $key ) {
			...
			return '<div id="' . $this->product->get_key() . '-review-notification" class="milkyway-sdk-review-box">'
				   . '<p>' . $heading . '</p>'
				   . ( $msg ? '<p>' . $msg . '</p>' : '' )
				   . '<div class="actions">'
