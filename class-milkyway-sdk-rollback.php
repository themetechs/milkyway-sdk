<?php
/**
 * The rollback class for milkyway SDK
 *
 * @package     milkywaySDK
 * @subpackage  Rollback
...
if ( ! class_exists( 'milkyway_SDK_Rollback' ) ) :
	/**
	 * Rollback for milkyway SDK.
	 */
	class milkyway_SDK_Rollback {
		...
		/**
		 * milkyway_SDK_Rollback constructor.
		 *
		...
		/**
		 * Set the rollback hook. Strangely, this does not work if placed in the milkyway_SDK_Rollback class, so it is being called from there instead.
		 */
