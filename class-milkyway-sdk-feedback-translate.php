<?php
/**
 * The Translate feedback model class for milkyway SDK
 *
 * @package     milkywaySDK
 * @subpackage  Feedback
...
if ( ! class_exists( 'milkyway_SDK_Feedback_Translate' ) ) :
	/**
	 * Translate feedback model for milkyway SDK.
	 */
	class milkyway_SDK_Feedback_Translate extends milkyway_SDK_Feedback {
...
The process is easy, and you can join by following the link below!';
		...
		/**
		 * milkyway_SDK_Feedback_Translate constructor.
		 *
		...
		function admin_notices() {
			...
			if ( $html ) {
				echo '<div class="notice notice-success is-dismissible" id="' . $id . '" ><div class="milkyway-translate-box">' . $html . '</div></div>';
			}
		}
		...
		function get_html( $key ) {
			...
			return '<div id="' . $this->product->get_key() . '-translate-notification" class="milkyway-sdk-translate-box">'
				   . '<h2>' . $heading . '</h2>'
				   . '<p>' . $message . '</p>'
				   . '<div class="actions">'
