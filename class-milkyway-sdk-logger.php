 ...
 * @since       1.0.0
 */
if ( ! class_exists( 'milkyway_SDK_Logger' ) ) :
	/**
	 * Class milkyway_SDK_Logger
	 *
	 * Send the statistics to the milkyway Endpoint
	 */
	/**
	 * Class milkyway_SDK_Logger
	 */
	class milkyway_SDK_Logger {
		 ...
		 */
		private $logging_url = 'http://log.milkyway.com/wp-json/v1/logs/';
		...
		/**
		 * milkyway_SDK_Logger constructor.
		 *
		...
		function admin_notices() {
			...
			echo '<div class="notice notice-success is-dismissible "  id="' . $this->product->get_key() . '-logger-notification" ><div id="' . $id . '" class="milkyway-logger-box">' . $this->get_html( $this->product->get_key() ) . '</div></div>';
		}
